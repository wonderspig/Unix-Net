...
#define	RTT_RXTMIN      2	/* min retransmit timeout value, seconds 最小重传超时值*/
#define	RTT_RXTMAX     60	/* max retransmit timeout value, seconds 最大重传超时值*/
#define	RTT_MAXNREXMT 	3	/* max #times to retransmit 最大重传次数*/
